...
Route::controller(Controllers\LoginController::class)->group(function(){
    ...
    Route::post('/login/entrar', 'Entrar')->name('login.entrar');
    Route::get('/login/sair', 'Sair')->name('login.sair');
});


Route::controller(Admin\CursoController::class)->middleware(['auth'])->group(function(){
